...
import controller.InstitutoSet;
import controller.InstitutoSetNormal;
import controller.InstitutoSetStream;
import model.Alumno;
import model.Unidad;

public class Principal {

//	static InstitutoSet insti = new InstitutoSetNormal();
	static InstitutoSet insti = new InstitutoSetStream();

	public static void main(String[] args) {

		boolean leerDelFichero = true;
		if (leerDelFichero) {
			insti.cargarAlumnos();
		} else {
			generarDatos();
